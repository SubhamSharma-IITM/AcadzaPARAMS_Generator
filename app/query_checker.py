...
- If you identify from the query that the student wants to learn a specifc portion or chapter or has any doubt in understanding then it should include → concept dost + assigment + formula sheet + test of those portion(s).
