...
def build_payload(dost_type, request, tree):
    ...
    for group in chapter_groups:
        ...
        if dost_type == "practiceAssignment":
            payload = build_assignment(subject, chapter, concepts, params, subconcepts)
        elif dost_type == "practiceTest":
            payload = build_test(subject, chapter, concepts, params, subconcepts)
